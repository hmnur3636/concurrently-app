...

{
  ...
  choices: [
    ...
    { text: 'Go Right', nextId: 7 },
    { text: 'Let me read This Note Real Quick', nextId: 6 },
    { text: 'Never Mind, I Will Go Back', nextId: 5 },
]
},

{
  ...
  choices: [
    { text: 'Go left', nextId: 25 },
    { text: 'Go Right', nextId: 7 },
    { text: 'Let Double Check This Note Real Quick', nextId: 5 },
    { text: 'Never Mind, I Will Go Back', nextId: 1 },
]
},

{
  ...
  choices: [
    { text: 'Go left', nextId: 25 },
    { text: 'Go Right', nextId: 7 },
    { text: 'Let me read This Note Real Quick Again', nextId: 6 },
    { text: 'Never Mind, I Will Go Back', nextId: 1 },
]
},

{
  ...
  choices: [
    { text: 'Open The Chest', nextId: 5 },
    { text: 'Pull the Lever', nextId: 8 },
    { text: 'Grab The Torch', nextId: 6 },
    { text: 'What Does This Note Say?', nextId: 6 },
    { text: 'I Think This Is The Wrong Way, Let Me Head Back', nextId: 1 },
]
},
...
choices: [
  { text: 'Open The Chest', nextId: 5 },
  { text: 'Through The Gateway', nextId: 6 },
  { text: 'Grab The Torch', nextId: 6 },
  { text: 'What Does This Note Say?', nextId: 6 },
  { text: 'I Think This Is The Wrong Way, Let Me Head Back', nextId: 1 },
]
